...
<head>
  ...
  <title>Media Manager - {{ config('app.name') }}</title>
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/72px color.png') }}">
  <link rel="stylesheet" href="{{ asset('staff/admin/css/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('staff/vendors/font-awesome-5.5/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('staff/vendors/jquery-ui-1.11.2/jquery-ui.min.css') }}">
...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('staff.unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script src="{{ asset('staff/vendors/jquery-ui-1.11.2/jquery-ui.min.js') }}"></script>
