...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('staff.report.sales-by-product') }}" method="get">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-content-center">
            ...
            <a href="{{ route('staff.report.sales-by-product', \Illuminate\Support\Arr::add($params, 'download', 1)) }}"
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $('#data-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('staff.report.sales-by-product', $params) }}',
                    columns: [
