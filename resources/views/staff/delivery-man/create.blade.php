...
@section('page_title', 'Create Delivery Man')
...
@section('content')
   ...
   <div class="row pt-2 pb-2">
    ...
    <div  id="app">
        <form action="{{ route('staff.catalog.delivery-man.store') }}" method="post">
            @csrf
                    ...
                    <div class="col-xl-9 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary btn-block btn-lg" type="submit">Save Profile</button>
                                </div>
                            </div>
                        </div>
                    </div>
