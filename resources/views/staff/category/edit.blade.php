...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('staff.catalog.category.update', $category) }}" method="post">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tags[]" class="form-control" id="tags" multiple>
                                        @foreach($tags as $tag)
                                            <option
                                                value="{{ $tag->id }}" {{ in_array($tag->id, $old_tag_ids)?'selected':'' }}>{{ $tag->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control select2">
                                        ...
                                        <option value="0" {{ $category->status == 0?'selected':'' }}>Disabled
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meta[title]" value="{{ $metas['title']??'' }}"
                                            class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Meta Description</label>
                                    <textarea name="meta[description]"
                                                class="form-control">{{ $metas['description']??'' }}</textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lang[{{ $language->code }}][name]"
                                            value="{{ (is_array($translations) && isset($translations[$language->code])  && is_array($translations[$language->code]))?$translations[$language->code]['name']:'' }}"
                                            class="form-control">
                                </div>
                            </div>
                        </div>
