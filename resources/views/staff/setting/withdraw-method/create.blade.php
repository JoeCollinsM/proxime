...
@section('page_title', 'New Withdraw Method')
...
@section('content')
    ...
    <div id="app">
        ...
        <form action="{{ route('staff.setting.withdraw-method.store') }}" method="post">
            @csrf
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                            ...
                            <div class="card-body" v-cloak>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="status" name="status" type="checkbox"
                                                   {{ old('status')?'checked':'' }} data-toggle="toggle"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description"
                                              class="form-control @error('description') is-inavlid @enderror">{{ old('description') }}</textarea>
                                    @error('description')
                        ...
                        <div class="card mt-5" v-for="(field, index) in fields" :key="index" v-cloak>
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-danger btn-sm" @click.prevent="removeField(index)"><i
                        ...
                        <div class="form-group my-3">
                            <button class="btn btn-lg btn-outline-success btn-block" type="submit">Save</button>
                        </div>
                    </div>
                </div>
