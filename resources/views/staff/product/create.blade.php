...
@section('content')
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="{{ route('staff.catalog.product.index') }}">Products</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
                    <form action="{{ route('staff.catalog.product.store') }}" method="post">
                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select2 name="shop_id" class="form-control" v-model="shop_id" required>
                                                        @foreach($shops as $shop)
                                                            <option
                                                                    value="{{ $shop->id }}" {{ old('shop_id') == $shop->id?'selected':'' }}>{{ $shop->name }}</option>
                                                        @endforeach
                                                    </select2>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="per" value="{{ old('per')??1 }}"
                                                            class="form-control" required>
                                                        <div class="input-group-append">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="delivery_time"
                                                            value="{{ old('delivery_time')??1 }}"
                                                            class="form-control" required>
                                                        <div class="input-group-append">
                                                        <span class="input-group-text"
                                                            v-if="delivery_time_type == '1'">Hour(s)</span>
                                                            <span class="input-group-text"
                                                                v-else-if="delivery_time_type == '2'">Day(s)</span>
                                                            <span class="input-group-text"
                                                                v-else-if="delivery_time_type == '3'">Week(s)</span>
                                                            <span class="input-group-text"
                                                                v-else-if="delivery_time_type == '4'">Month(s)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control select2">
                                                        ...
                                                        <option value="2" {{ old('status') == 2?'selected':'' }}>Disabled
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Is Free Shipping?</label>
                                                    <select name="is_free_shipping" class="form-control select2">
                                                        <option value="0" {{ old('is_free_shipping') == 0?'selected':'' }}>NO
                                                        </option>
                                                        <option value="1" {{ old('is_free_shipping') == 1?'selected':'' }}>YES
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                        ...
                        <div id="accordion1">
                            <div class="card mb-2">
                                <div class="card-header mb-2 d-flex justify-content-between align-content-center" 
                                                data-toggle="collapse" data-target="#details" aria-expanded="false" aria-controls="details">
                                    Product Details
                                </div>

                                <div id="details" class="collapse show" data-parent="#accordion1">
                                <div class="card-body">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="control-label">Description</label>
                                            <textarea name="content" id="content"
                                                    class="form-control editor">{!! clean(old('content')) !!}</textarea>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card mb-2">
                                ...
                                <div id="attributes" class="collapse" data-parent="#accordion1">
                                <div class="card-body">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <select2 :tags="true" :id="'attribute-content-' + index"
                                                            ...
                                                            v-model="attribute.content" placeholder="S|M|L|XL|XXL" :options="attribute.options" multiple></select2>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <div class="card">
                                ...
                                <div id="variations" class="collapse" data-parent="#accordion1">
                                <div class="card-body">
                                    <div class="form-group text-right">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lang[{{ $language->code }}][title]"
                                            value="{{ (is_array(old('lang')) && is_array(old('lang')[$language->code]))?old('lang')[$language->code]['title']:'' }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Description</label>
                                        <textarea name="lang[{{ $language->code }}][content]"
                                                class="form-control editor">{!! clean((is_array(old('lang')) && is_array(old('lang')[$language->code]))?old('lang')[$language->code]['content']:'') !!}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Excerpt</label>
                                        <textarea name="lang[{{ $language->code }}][excerpt]"
                                                class="form-control">{{ (is_array(old('lang')) && is_array(old('lang')[$language->code]))?old('lang')[$language->code]['excerpt']:'' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
`,
        ...
        window.app = new Vue({
            ...
            data: {
                ...
                slug: '{{ old('slug')??'' }}',
                sku: '{{ old('sku')??'' }}',
                general_price: '{{ old('general_price')??0 }}',
                sale_price: '{{ old('sale_price')??0 }}',
                tax: '{{ old('tax')??0 }}',
                unit: '{{ old('unit')??'kg' }}',
                delivery_time_type: '{{ old('delivery_time_type')??2 }}',
                attributes: @json((old('attributes') && is_array(old('attributes')))?old('attributes'):[]),
                variations: @json((old('variations') && is_array(old('variations')))?old('variations'):[]),
                add_attribute_id: -1,
                all_attributes: @json($attributes),
            },
            beforeMount() {
            ...
            methods: {
                ...
                generateVariations() {
                    _app = this
                    $.post("{{ route('staff.catalog.product.variations') }}", {
                        _token: "{{ csrf_token() }}",
