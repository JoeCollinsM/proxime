...
@section('content')
    ...
    <div  id="app" v-cloak>
            ...
            <form action="{{ route('staff.catalog.product.update', $product->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class=" card">
                    <div
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select2 name="shop_id" class="form-control" v-model="shop_id" required>
                                            @foreach($shops as $shop)
                                                <option
                                                    value="{{ $shop->id }}" {{ $product->shop_id == $shop->id?'selected':'' }}>{{ $shop->name }}</option>
                                            @endforeach
                                        </select2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control select2">
                                            ...
                                            <option value="2" {{ $product->status == 2?'selected':'' }}>Disabled
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="is_free_shipping" class="form-control select2">
                                            <option value="0" {{ $product->is_free_shipping == 0?'selected':'' }}>NO
                                            </option>
                                            <option value="1" {{ $product->is_free_shipping == 1?'selected':'' }}>YES</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
