...
@section('content')
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item">Sales by Date</li>
         </ol>
	   </div>
     </div>
    <!-- End Breadcrumb-->
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ route('shop.report.sales-by-date') }}" method="get">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-content-center">
                    ...
                    <a href="{{ route('shop.report.sales-by-date', \Illuminate\Support\Arr::add($params, 'download', 1)) }}"
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $('#data-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('shop.report.sales-by-date', $params) }}',
                    columns: [
