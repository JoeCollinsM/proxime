  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="{{ auth()->guard('shop')->user()->logo }}" class="img-circle" alt=""></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="{{ auth()->guard('shop')->user()->logo }}" alt=""></div>
            <div class="media-body">
            <h6 class="mt-2 user-title">{{ auth()->guard('shop')->user()->vendor_name }}</h6>
            </div>
           </div>
          </a>
        </li>
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><a href="{{ route('shop.transaction.index') }}">{{ auth('shop')->user()->balance }} {{ \App\Models\Currency::getDefaultCurrency()->code }}</a></li>
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><a href="{{ route('shop.profile') }}"><i class="icon-user mr-2"></i> Profile </a></li>
        <li class="dropdown-divider"></li>
